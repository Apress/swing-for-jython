...
#-------------------------------------------------------------------------------
class getHeaders1( java.lang.Runnable ) :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( getHeaders1() )
