...
#    Note: Adds a divided splitpane and assigns the divider position
#   Usage: wsadmin -wsadmin_classpath jsoup-1.8.1.jar -f javadocInfo_05.py
#            or
#     ...  JYTHONPATH must include path to jsoup*.jar
#          e.g., set JYTHONPATH=C:\Programs\jsoup\jsoup-1.8.1.jar;
#          jython javadocInfo_05.py
# History:
...
try :
    ...
    if 'AdminConfig' in dir() :
        print 'e.g.: wsadmin -wsadmin_classpath jsoup-1.8.1.jar -f javadocInfo.py'
    else :
...
#-------------------------------------------------------------------------------
class javadocInfo( java.lang.Runnable ) :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( javadocInfo() )
    if 'AdminConfig' in dir() :
