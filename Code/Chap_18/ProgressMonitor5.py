...
#    Note: 
#   Usage: wsadmin -f ProgressMonitor5.py
#            or
#          jython ProgressMonitor5.py
# History:
...
#-------------------------------------------------------------------------------
# Name: ProgressMonitor5()
# Role: Used to demonstrate how to create, and display a JFrame instance
# Note: This class should be instantiated on the Swing Event Dispatch Thread
#-------------------------------------------------------------------------------
class ProgressMonitor5( java.lang.Runnable ) :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( ProgressMonitor5() )
