...
#    Note: 
#   Usage: wsadmin -f ProgressMonitor4.py
#            or
#          jython ProgressMonitor4.py
# History:
...
#-------------------------------------------------------------------------------
# Name: ProgressMonitor4()
# Role: Used to demonstrate how to create, and display a JFrame instance
# Note: This class should be instantiated on the Swing Event Dispatch Thread
#-------------------------------------------------------------------------------
class ProgressMonitor4( java.lang.Runnable ) :
    ...
    def start( self, event ) :
        ...
        msg = '<html><font color="red">Warning!</font>'
#       msg = '<html><font color="red">Warning! Danger Will Robinson, Danger!</font>'
#       msg = '<html><ol><li>Now</li><li>is</li><li>the</li><li>time.</li></ol>'
#       msg = '<html><ul><li>Now</li><li>is</li><li>the</li><li>time.</li></ul>'
...
#       print 'Update():', event.getPropertyName(), self.PM.isCanceled(), self.task.isDone()
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( ProgressMonitor4() )
