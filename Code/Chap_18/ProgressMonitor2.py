...
#    Note: 
#   Usage: wsadmin -f ProgressMonitor2.py
#            or
#          jython ProgressMonitor2.py
# History:
...
#-------------------------------------------------------------------------------
# Name: ProgressMonitor2()
# Role: Used to demonstrate how to create, and display a JFrame instance
# Note: This class should be instantiated on the Swing Event Dispatch Thread
#-------------------------------------------------------------------------------
class ProgressMonitor2( java.lang.Runnable ) :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( ProgressMonitor2() )
