...
#    Note: This iteration simplifies the main class by removing the multiple
#          inheritance and having the progressTask (i.e., SwingWorker class)
#          assign the PropertyChangeListener event handler in the constructor
#   Usage: wsadmin -f ProgressBar3.py
#            or
#          jython ProgressBar3.py
# History:
...
#-------------------------------------------------------------------------------
class ProgressBar3( java.lang.Runnable ) :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( ProgressBar3() )
