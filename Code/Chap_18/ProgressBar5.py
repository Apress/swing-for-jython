#-------------------------------------------------------------------------------
#    Name: ProgressBar5.py
#    From: Swing for Jython
#      By: Robert A. (Bob) Gibson [rag]
# ISBN-13: 978-1-4824-0818-2 (paperback)
# ISBN-13: 978-1-4824-0817-5 (electronic)
# website: http://www.apress.com/978148420818
#    Role: Simple Jython Swing script showing a JProgressBar with non-default
#          minimum and maximum values
#   Usage: wsadmin -f ProgressBar5.py
#            or
#          jython ProgressBar5.py
# History:
...
#-------------------------------------------------------------------------------
class ProgressBar5( java.lang.Runnable ) :
    ...
    def run( self ) :
        ...
        self.progressBar = panel.add(
            JProgressBar( 50, 500, stringPainted = 1 )
        )
        frame.add(
            panel,
            BorderLayout.NORTH
    ...
    def propertyUpdate( self, event ) :
        if event.getPropertyName() == 'progress' :
            ...
            lo    = self.progressBar.getMinimum()
            hi    = self.progressBar.getMaximum()
            here  = int( ( hi - lo ) * 0.01 * progress ) + lo
#           print '%3d%% of %3d..%3d = %3d' % ( progress, lo, hi, here )
            self.progressBar.setValue( here )
            if progress == 100 :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( ProgressBar5() )
