...
#    Note: 
#   Usage: wsadmin -f ProgressMonitor3.py
#            or
#          jython ProgressMonitor3.py
# History:
...
#-------------------------------------------------------------------------------
# Name: ProgressMonitor3()
# Role: Used to demonstrate how to create, and display a JFrame instance
# Note: This class should be instantiated on the Swing Event Dispatch Thread
#-------------------------------------------------------------------------------
class ProgressMonitor3( java.lang.Runnable ) :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( ProgressMonitor3() )
