#-------------------------------------------------------------------------------
#    Name: MethodTable2.py
#    From: Swing for Jython
#      By: Robert A. (Bob) Gibson [rag]
# ISBN-13: 978-1-4824-0818-2 (paperback)
# ISBN-13: 978-1-4824-0817-5 (electronic)
# website: http://www.apress.com/978148420818
#    Role: Simple wsadmin Jython script seeing what is needed to display the
#          method portion of the Help.help() text in a scrollable JTable.
#          Also demonstrate one technique for highlighting text within a table.
#    Note: This requires a WebSphere Application Server environment.
#   Usage: wsadmin -f MethodTable2.py
# History:
...
#-------------------------------------------------------------------------------
class MethodTable2( java.lang.Runnable ) :
    ...
    #       of findWord value hightlighted
    #---------------------------------------------------------------------------
...
if __name__ in [ '__main__', 'main' ] :
    if 'AdminConfig' in dir() :
        EventQueue.invokeLater( MethodTable2() )
        raw_input( '\nPress <Enter> to terminate the application:\n' )
    else :
        print '\nError: This script requires a WebSphere environment.'
        print 'Usage: wsadmin -f MethodTable2.py'
else :
