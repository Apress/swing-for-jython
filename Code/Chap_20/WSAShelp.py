...
#   Usage: wsadmin -f WSAShelp.py
# History:
#   date    who  ver   Comment
# --------  ---  ---   ----------
# 14/11/03  rag  1.00  Chg - make this version 1.00
...
Purpose: A wsadmin Jython script demonstrating some techniques for graphically
 ...
 Author: Robert A. (Bob) Gibson <bgibson@us.ibm.com>
  ...
  Usage: wsadmin -f WSAShelp.py
Example: ./wsadmin.sh -f WSAShelp.py\n
Version: 1.00
Updated: 03 Nov 2014
'''
...
#-------------------------------------------------------------------------------
class WSAShelp( java.lang.Runnable ) :
    ...
    #---------------------------------------------------------------------------
    # Name: frameResized()
    # Role: Component Listener event handlre for the componentResized event
    #---------------------------------------------------------------------------
...
if __name__ in [ '__main__', 'main' ] :
    if 'AdminConfig' in dir() :
        EventQueue.invokeLater( WSAShelp() )
        raw_input( '\nPress <Enter> to terminate the application:\n' )
    else :
        print '\nError: This script requires a WebSphere environment.'
        print 'Usage: wsadmin -f WSAShelp.py'
else :
