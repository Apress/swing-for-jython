...
#    Note: Iteration #7 - Add another type of internal frame, one with a button
#   Usage: wsadmin -f consoleTimeout_07.py
# History:
...
website: http://www.apress.com/978148420818
  ...
  Usage: wsadmin -f consoleTimeout_07.py
Example: ./wsadmin.sh -f consoleTimeout_07.py
'''
...
if __name__ == '__main__' :
    if 'AdminConfig' in dir() :
        EventQueue.invokeLater( consoleTimeout_07() )
        raw_input( '\nPress <Enter> to terminate the application:\n' )
    else :
        print '\nError: This script requires the WebSphere Application Server product.'
        print 'Usage: wsadmin -f consoleTimeout_07.py'
else :
