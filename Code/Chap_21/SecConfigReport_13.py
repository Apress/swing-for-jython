...
#   Usage: wsadmin -f SecConfigReport_13.py
# History:
...
Purpose: A wsadmin Jython script demonstrating some techniques for graphically
 ...
 Author: Robert A. (Bob) Gibson <bgibson@us.ibm.com>
  ...
  Usage: wsadmin -f SecConfigReport_13.py
Example: ./wsadmin.sh -f SecConfigReport_13.py\n
Version: 0.13
Updated: 26 Jan 2013
'''
...
#-------------------------------------------------------------------------------
# Name: SecConfigReport_13()
# Role: Used to demonstrate how to create, and display a JFrame instance
# Note: This class should be instantiated on the Swing Event Dispatch Thread
#-------------------------------------------------------------------------------
class SecConfigReport_13( java.lang.Runnable ) :
        ...
        if event.getClickCount() == 2 :
            ...
            if view > -1 :
                ...
                if model.getValueAt( row, 0 ).startswith( '_' ) :
                    ...
                    model.setSectionVisible(
                        sNum,
                        not model.isSectionVisible( sNum )
                    )
                else :
                    sNum = -1
            else :
...
if __name__ in [ '__main__', 'main' ] :
    if 'AdminConfig' in dir() :
        EventQueue.invokeLater( SecConfigReport_13() )
        raw_input( '\nPress <Enter> to terminate the application:\n' )
    else :
        print '\nError: This script requires a WebSphere environment.'
        print 'Usage: wsadmin -f SecConfigReport_13.py'
else :
