...
#   Usage: wsadmin -f WASports_08.py
# History:
...
Purpose: A wsadmin Jython script demonstrating various techniques to graphically
 ...
 Author: Robert A. (Bob) Gibson <bgibson@us.ibm.com>
  ...
  Usage: wsadmin -f WASports_08.py
Example: ./wsadmin.sh -f WASports_08.py\n
Version: 08
Updated: 19 Apr 2014
'''
...
#-------------------------------------------------------------------------------
class WASports_08( java.lang.Runnable ) :
    ...
    #---------------------------------------------------------------------------
    # Name: Exit()
    # Role: File -> Exit menu item event handler : terminate the application
    #---------------------------------------------------------------------------
    def Exit( self, e ) :
        sys.exit()
...
if __name__ == '__main__' :
    if 'AdminConfig' in dir() :
        EventQueue.invokeLater( WASports_08() )
        raw_input( '\nPress <Enter> to terminate the application:\n' )
    else :
        print '\nError: This script requires a WebSphere environment.'
        print 'Usage: wsadmin -f WASports_08.py'
else :
