...
#   Usage: wsadmin -f WASports_06.py
# History:
...
class PortTableModel( DefaultTableModel ) :
    ...
    # Note: Only values in the range: 0..65535 are allowed
    #---------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
class WASports_06( java.lang.Runnable ) :
...
if __name__ == '__main__' :
    if 'AdminConfig' in dir() :
        EventQueue.invokeLater( WASports_06() )
        raw_input( '\nPress <Enter> to terminate the application:\n' )
    else :
        print '\nError: This script requires a WebSphere environment.'
        print 'Usage: wsadmin -f WASports_06.py'
else :
