...
#          components using a BorderLayout layout manager using non-default
#          horizontal and vertical gaps between the components.
#    Note: None of the buttons have an ActionListener event handler assigned
#   Usage: wsadmin -f BorderLayoutGap.py
#            or
#          jython BorderLayoutGap.py
# History:
