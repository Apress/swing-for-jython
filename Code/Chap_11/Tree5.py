...
#    Role: Simple Jython Swing script demonstrating editable tree nodes
#          I was so tempted to write "edible"... ;-)
#    Note: A WebSphere Application Server environment is required.
#          To edit a name, triple click on the name.
#   Usage: wsadmin -f Tree5.py
# History:
...
#-------------------------------------------------------------------------------
class Tree5( java.lang.Runnable ) :
