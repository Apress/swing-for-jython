...
#    Role: Simple Jython Swing script to display the WebSphere cell hierarchy
#    Note: A WebSphere Application Server environment is required.
#   Usage: wsadmin -f Tree1.py
# History:
...
#-------------------------------------------------------------------------------
class Tree1( java.lang.Runnable ) :
    ...
    def run( self ) :
        ...
        frame.add( JScrollPane( self.cellTree() ) )
        frame.setVisible( 1 )
...
if __name__ in [ '__main__', 'main' ] :
    if 'AdminConfig' in dir() :
        EventQueue.invokeLater( Tree1() )
        raw_input( '\nPress <Enter> to terminate the application:\n' )
    else :
        print '\nError: This script requires a WebSphere environment.'
        print 'Usage: wsadmin -f Tree1.py'
else :
