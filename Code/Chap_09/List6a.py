...
#          an InputMethodListener
#   Usage: wsadmin -f List6a.py
#            or
#          jython List6a.py
# History:
...
#-------------------------------------------------------------------------------
# Name: IML()
# Role: Implement an InputMethodListener class to monitor a text input field
#-------------------------------------------------------------------------------
class IML( InputMethodListener ) :
...
#-------------------------------------------------------------------------------
class List6a( java.lang.Runnable ) :
    ...
    def run( self ) :
        ...
        self.text.addInputMethodListener( IML() )
