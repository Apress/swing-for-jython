...
#          JFileChooser class
#    Note: This uses a FileSystemView
#   Usage: wsadmin -f FileChooserDemo2.py
#            or
#          jython FileChooserDemo2.py
# History:
...
#-------------------------------------------------------------------------------
# Name: FileChooserDemo2()
# Role: Used to demonstrate how to create, and display a JFrame instance
# Note: This class should be instantiated on the Swing Event Dispatch Thread
#-------------------------------------------------------------------------------
class FileChooserDemo2( java.lang.Runnable ) :
    ...
    #---------------------------------------------------------------------------
    # Name: showFC()
    # Role: Demonstrate a JFileChooser using a FileSystemView
    #---------------------------------------------------------------------------
    def showFC( self, event ) :
        fc = JFileChooser( FileSystemView.getFileSystemView() )
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( FileChooserDemo2() )
