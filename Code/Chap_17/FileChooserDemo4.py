...
#    Note: This adds a FileNameExtensionFilter
#   Usage: wsadmin -f FileChooserDemo4.py
#            or
#          jython FileChooserDemo4.py
# History:
...
#-------------------------------------------------------------------------------
# Name: FileChooserDemo4()
# Role: Used to demonstrate how to create, and display a JFrame instance
# Note: This class should be instantiated on the Swing Event Dispatch Thread
#-------------------------------------------------------------------------------
class FileChooserDemo4( java.lang.Runnable ) :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( FileChooserDemo4() )
