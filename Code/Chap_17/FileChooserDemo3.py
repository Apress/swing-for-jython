...
#    Note: This provides a restricted file system view
#   Usage: wsadmin -f FileChooserDemo3.py
#            or
#          jython FileChooserDemo3.py
# History:
...
#-------------------------------------------------------------------------------
# Name: FileChooserDemo3()
# Role: Used to demonstrate how to create, and display a JFrame instance
# Note: This class should be instantiated on the Swing Event Dispatch Thread
#-------------------------------------------------------------------------------
class FileChooserDemo3( java.lang.Runnable ) :
    ...
    #---------------------------------------------------------------------------
    # Name: showFC()
    # Role: Demonstrate a JFileChooser using a RestrictedFileSystemView
    #---------------------------------------------------------------------------
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( FileChooserDemo3() )
