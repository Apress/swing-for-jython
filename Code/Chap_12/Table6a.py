...
#    Role: Simple Jython Swing script using a JFormattedTextField component
#    Note: This uses a default numeric formatting
#   Usage: wsadmin -f Table6a.py
#            or
#          jython Table6a.py
# History:
...
#-------------------------------------------------------------------------------
class Table6a( java.lang.Runnable ) :
...
if __name__ in [ '__main__', 'main' ] :
    EventQueue.invokeLater( Table6a() )
