...
#    Role: Simple Jython Swing script using a more complete table model
#          implementation
#   Usage: wsadmin -f Table4.py
#            or
#          jython Table4.py
# History:
...
class myTM( DefaultTableModel ) :
    ...
    def getColumnClass( self, col ) :
        return [ Date, Integer, String ][ col ]
...
#-------------------------------------------------------------------------------
class Table4( java.lang.Runnable ) :
