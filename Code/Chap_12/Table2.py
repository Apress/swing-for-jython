...
#    Note: This demonstrates how to limit the selection to a single row
#   Usage: wsadmin -f Table2.py
#            or
#          jython Table2.py
# History:
...
#-------------------------------------------------------------------------------
class Table2( java.lang.Runnable ) :
