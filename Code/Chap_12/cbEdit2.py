...
#    Note: Setting the renderer provides the user with an indication that these
#          values are, in fact, a ComboBox selection
#   Usage: wsadmin -f cbEdit2.py
#            or
#          jython cbEdit2.py
# History:
...
#-------------------------------------------------------------------------------
class cbEdit2( java.lang.Runnable ) :
