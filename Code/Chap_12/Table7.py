...
#    Role: Simple Jython Swing script adjusting column widths
#    Note: The width is only based upon the column header
#   Usage: wsadmin -f Table7.py
#            or
#          jython Table7.py
# History:
...
#-------------------------------------------------------------------------------
class Table7( java.lang.Runnable ) :
