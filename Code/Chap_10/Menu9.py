...
#    Role: Simple Jython Swing script showing how to add an accelerator key (x)
#          to the File -> Exit menuitem.
#   Usage: wsadmin -f Menu9.py
#            or
#          jython Menu9.py
# History:
...
#-------------------------------------------------------------------------------
class Menu9( java.lang.Runnable ) :
